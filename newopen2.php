...
<div class="well">
    <h3>New Open Coffees <a href="add_new.php" class="btn btn-default pull-right"><i class="fa fa-plus"></i> New </a>
    </h3>
</div>
...
<?php
	...
	$query1 = "SELECT * FROM coffee_shop WHERE type='New Open' AND admin_id=$admin_id  ORDER BY coffee_id DESC";
	
	$result1 = mysqli_query($connection, $query1);
	$count = mysqli_num_rows($result1);
	if($count == 0) {
		echo '<div class=" alert-error ">';
			echo "<p>No Newly open Coffees Found</p>";
		echo '</div>';
