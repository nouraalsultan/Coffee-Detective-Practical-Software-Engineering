...
<div class="well">
    <h3>Out Door Coffees <a href="add_new.php" class="btn btn-default pull-right"><i class="fa fa-plus"></i> New </a>
    </h3>
</div>
...
<?php
	...
	$query1 = "SELECT * FROM coffee_shop WHERE type='Out Door' AND admin_id=$admin_id  ORDER BY coffee_id DESC";
